...
with open(r'/home/nguyentienbao/Documents/PycharmProjects/img_preprocessing/weight/weight0.txt', 'wb') as f:
    np.save(f, weight)
# with open(r'/home/nguyentienbao/Documents/PycharmProjects/img_preprocessing/bias/bias10.txt', 'w') as f:
#     f.write("\n".join(map(str, weight)))
# f.close()
