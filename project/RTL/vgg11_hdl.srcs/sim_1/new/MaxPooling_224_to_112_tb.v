...
module MaxPooling_224_to_112_tb();
	...
	initial begin
		pixel_data = $fopen("D:/TaiLieuHocTapSharing/ChuyenDeThietKeViMach1/CNNProject/TxtFile/gray_ieee754.txt", "r");
		pixel_result = $fopen("D:/TaiLieuHocTapSharing/ChuyenDeThietKeViMach1/CNNProject/TxtFile/MaxPool224_Result_ieee754.txt", "w");
