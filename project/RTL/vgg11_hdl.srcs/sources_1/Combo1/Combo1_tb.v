...
module Combo1_tb();
  ...
  //------------------
	...
	initial begin
		pixel_red_in = $fopen("....path to red map 224 x 224 file....", "r");
		pixel_green_in = $fopen("....path to green map 224 x 224 file....", "r");
		pixel_blue_in = $fopen("....path to blue map 224 x 224 file....", "r");
		result_map0 = $fopen("....path to result....", "w");
