...
(
	...
	ff_ram_256 #(DATA_WIDTH, ADDR_WIDTH, DEPTH) 
	ff_ram_256_inst 
												(
											  .cs(cs_out),								
											  .rws(push_pop),							
	...
	Write_Pointer_256 #(ADDR_WIDTH, ptr0, ptr1)
	Write_Pointer_256_inst							(
																.clk(clk),
																.rst(reset),
																.fifo_we(we_out),
																.wptr(wptr_out)
	...
	Read_Pointer_256 #(ADDR_WIDTH, ptr0, ptr1)
	Read_Pointer_256_inst  					(
																.clk(clk),
																.rst(reset),
																.fifo_re(re_out),
																.rptr(rptr_out)
	...
	Status_Signal_256 #(ADDR_WIDTH)
	Status_Signal_256_inst 					(
																.ff_en(en),
