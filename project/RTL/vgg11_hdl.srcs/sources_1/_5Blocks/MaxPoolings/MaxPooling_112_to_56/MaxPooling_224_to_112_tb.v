...
module MaxPooling_224_to_112_tb();
	...
	initial begin
		pixel_data = $fopen("D:/TaiLieuHocTapSharing/ChuyenDeThietKeViMach1/CNNProject/VGG_mini/TxtFile/gray224_ieee754.txt", "r");
		pixel_result = $fopen("D:/TaiLieuHocTapSharing/ChuyenDeThietKeViMach1/CNNProject/VGG_mini/TxtFile/MaxPool224_Result3.txt", "w");
	...
	MaxPooling_224_to_112 MaxPooling_224_to_112_dut(clk, reset, DATA_IN, DATA_OUT);
endmodule
