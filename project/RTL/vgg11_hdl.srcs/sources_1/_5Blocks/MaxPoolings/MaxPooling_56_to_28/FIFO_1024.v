...
#(
	...
	parameter ptr0 = 11'b0,
	parameter ptr1 = 11'b1
)
...
(
	...
	ff_ram_1024 #(DATA_WIDTH, ADDR_WIDTH, DEPTH) 
	ff_ram_1024_inst 
												(
											  .cs(cs_out),								
											  .rws(push_pop),							
	...
	Write_Pointer_1024 #(ADDR_WIDTH, ptr0, ptr1)
	Write_Pointer_1024_inst							(
																.clk(clk),
																.rst(reset),
																.fifo_we(we_out),
																.wptr(wptr_out)
	...
	Read_Pointer_1024 #(ADDR_WIDTH, ptr0, ptr1)
	Read_Pointer_1024_inst  					(
																.clk(clk),
																.rst(reset),
																.fifo_re(re_out),
																.rptr(rptr_out)
	...
	Status_Signal_1024 #(ADDR_WIDTH)
	Status_Signal_1024_inst 					(
																.ff_en(en),
