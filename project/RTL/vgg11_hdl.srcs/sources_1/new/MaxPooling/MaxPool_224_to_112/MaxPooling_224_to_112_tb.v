...
module MaxPooling_224_to_112_tb();
	...
	initial begin
		pixel_data = $fopen("D:/TaiLieuHocTapSharing/ChuyenDeThietKeViMach1/CNNProject/TxtFile/gray224_ieee754.txt", "r");
		pixel_result = $fopen("D:/TaiLieuHocTapSharing/ChuyenDeThietKeViMach1/CNNProject/TxtFile/MaxPool224_Result.txt", "w");
